...
# `cargo install cargo-fuzz`. See fuzz/fuzz_targets/ for available targets.
# Findings land in fuzz/artifacts/<target>/.
fuzz target="dns_message_parse" seconds="60":
    cargo +nightly fuzz run {{target}} -- -max_total_time={{seconds}} -timeout=10 -max_len=65535
