...
- Unit tests should cover listener lifecycle, datagram handling, observed source endpoint and listener context propagation, concurrency limits, shutdown behavior, upstream failover/degraded state, timeout behavior, TCP framing paths, and response source validation.
