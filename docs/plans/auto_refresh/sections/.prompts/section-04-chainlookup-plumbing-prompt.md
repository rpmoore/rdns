...
Generate content for section `section-04-chainlookup-plumbing` (filename: `section-04-chainlookup-plumbing.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/home/rpmoore/code/rdns/docs/plans/auto_refresh/claude-plan.md` - Full implementation plan
2. `/home/rpmoore/code/rdns/docs/plans/auto_refresh/claude-plan-tdd.md` - Test stubs for each section
3. `/home/rpmoore/code/rdns/docs/plans/auto_refresh/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-04-chainlookup-plumbing` to understand what this section should contain.
...
`/home/rpmoore/code/rdns/docs/plans/auto_refresh/sections/section-04-chainlookup-plumbing.md`
