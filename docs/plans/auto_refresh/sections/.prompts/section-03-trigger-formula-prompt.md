...
Generate content for section `section-03-trigger-formula` (filename: `section-03-trigger-formula.md`).
...
for `section-03-trigger-formula` to understand what this section should contain.
...
`/home/rpmoore/code/rdns/docs/plans/auto_refresh/sections/section-03-trigger-formula.md`
