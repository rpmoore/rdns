...
Generate content for section `section-06-refresh-fetch-store` (filename: `section-06-refresh-fetch-store.md`).
...
for `section-06-refresh-fetch-store` to understand what this section should contain.
...
`/home/rpmoore/code/rdns/docs/plans/auto_refresh/sections/section-06-refresh-fetch-store.md`
