...
Generate content for section `section-01-popularity-bucket` (filename: `section-01-popularity-bucket.md`).
...
for `section-01-popularity-bucket` to understand what this section should contain.
...
`/home/rpmoore/code/rdns/docs/plans/auto_refresh/sections/section-01-popularity-bucket.md`
