...
Generate content for section `section-05-worker-pool-metrics` (filename: `section-05-worker-pool-metrics.md`).
...
for `section-05-worker-pool-metrics` to understand what this section should contain.
...
`/home/rpmoore/code/rdns/docs/plans/auto_refresh/sections/section-05-worker-pool-metrics.md`
