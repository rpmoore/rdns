...
Generate content for section `section-02-refresh-config` (filename: `section-02-refresh-config.md`).
...
for `section-02-refresh-config` to understand what this section should contain.
...
`/home/rpmoore/code/rdns/docs/plans/auto_refresh/sections/section-02-refresh-config.md`
