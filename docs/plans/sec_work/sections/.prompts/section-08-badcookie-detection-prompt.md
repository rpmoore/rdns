...
Generate content for section `section-08-badcookie-detection` (filename: `section-08-badcookie-detection.md`).
...
for `section-08-badcookie-detection` to understand what this section should contain.
...
`/home/rpmoore/code/rdns/docs/plans/sec_work/sections/section-08-badcookie-detection.md`
