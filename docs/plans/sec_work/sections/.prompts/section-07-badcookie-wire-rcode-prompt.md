...
Generate content for section `section-07-badcookie-wire-rcode` (filename: `section-07-badcookie-wire-rcode.md`).
...
for `section-07-badcookie-wire-rcode` to understand what this section should contain.
...
`/home/rpmoore/code/rdns/docs/plans/sec_work/sections/section-07-badcookie-wire-rcode.md`
