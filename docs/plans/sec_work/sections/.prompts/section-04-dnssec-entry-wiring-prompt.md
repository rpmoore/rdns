...
Generate content for section `section-04-dnssec-entry-wiring` (filename: `section-04-dnssec-entry-wiring.md`).
...
for `section-04-dnssec-entry-wiring` to understand what this section should contain.
...
`/home/rpmoore/code/rdns/docs/plans/sec_work/sections/section-04-dnssec-entry-wiring.md`
