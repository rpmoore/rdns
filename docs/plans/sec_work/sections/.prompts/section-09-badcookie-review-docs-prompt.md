...
Generate content for section `section-09-badcookie-review-docs` (filename: `section-09-badcookie-review-docs.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/home/rpmoore/code/rdns/docs/plans/sec_work/claude-plan.md` - Full implementation plan
2. `/home/rpmoore/code/rdns/docs/plans/sec_work/claude-plan-tdd.md` - Test stubs for each section
3. `/home/rpmoore/code/rdns/docs/plans/sec_work/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-09-badcookie-review-docs` to understand what this section should contain.
...
`/home/rpmoore/code/rdns/docs/plans/sec_work/sections/section-09-badcookie-review-docs.md`
