...
Generate content for section `section-05-dnssec-status-metrics` (filename: `section-05-dnssec-status-metrics.md`).
...
for `section-05-dnssec-status-metrics` to understand what this section should contain.
...
`/home/rpmoore/code/rdns/docs/plans/sec_work/sections/section-05-dnssec-status-metrics.md`
