...
+    pub(crate) response_code: ResponseCode, // almost always NoError; kept for
+    // parity with today's CachedResponse shape
+    pub(crate) minimum_ttl: Duration,
+    pub(crate) stored_at: SystemTime,
+    pub(crate) expires_at: SystemTime,
+    pub(crate) dnssec_state: DnssecState,
+    pub(crate) cache_namespace: String, // namespace is no longer part of the
...
+            rclass: IN_QCLASS,
+            ttl_at_store: 3600,
+            rdata: RecordData::A(Ipv4Addr::new(192, 0, 2, 53)), // placeholder RDATA
+        };
