...
Generate content for section `section-04-singleflight` (filename: `section-04-singleflight.md`).
...
for `section-04-singleflight` to understand what this section should contain.
...
`/home/rpmoore/code/rdns/docs/plans/cache_rework/sections/section-04-singleflight.md`
