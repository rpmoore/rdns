...
Generate content for section `section-05-namespace-sweep` (filename: `section-05-namespace-sweep.md`).
...
for `section-05-namespace-sweep` to understand what this section should contain.
...
`/home/rpmoore/code/rdns/docs/plans/cache_rework/sections/section-05-namespace-sweep.md`
