...
Generate content for section `section-02-data-model` (filename: `section-02-data-model.md`).
...
for `section-02-data-model` to understand what this section should contain.
...
`/home/rpmoore/code/rdns/docs/plans/cache_rework/sections/section-02-data-model.md`
