...
Generate content for section `section-03-shard-and-lru` (filename: `section-03-shard-and-lru.md`).
...
for `section-03-shard-and-lru` to understand what this section should contain.
...
`/home/rpmoore/code/rdns/docs/plans/cache_rework/sections/section-03-shard-and-lru.md`
