...
Generate content for section `section-06-opt-record-serialization` (filename: `section-06-opt-record-serialization.md`).
...
for `section-06-opt-record-serialization` to understand what this section should contain.
...
`/home/rpmoore/code/rdns/docs/plans/edns_cookie_cache/sections/section-06-opt-record-serialization.md`
