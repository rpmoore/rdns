...
Generate content for section `section-05-cache-miss-opt-path` (filename: `section-05-cache-miss-opt-path.md`).
...
for `section-05-cache-miss-opt-path` to understand what this section should contain.
...
`/home/rpmoore/code/rdns/docs/plans/edns_cookie_cache/sections/section-05-cache-miss-opt-path.md`
