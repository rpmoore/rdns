...
Generate content for section `section-07-knowledge-bundle-docs` (filename: `section-07-knowledge-bundle-docs.md`).
...
for `section-07-knowledge-bundle-docs` to understand what this section should contain.
...
`/home/rpmoore/code/rdns/docs/plans/edns_cookie_cache/sections/section-07-knowledge-bundle-docs.md`
