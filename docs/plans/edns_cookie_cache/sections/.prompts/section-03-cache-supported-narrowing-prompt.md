...
Generate content for section `section-03-cache-supported-narrowing` (filename: `section-03-cache-supported-narrowing.md`).
...
for `section-03-cache-supported-narrowing` to understand what this section should contain.
...
`/home/rpmoore/code/rdns/docs/plans/edns_cookie_cache/sections/section-03-cache-supported-narrowing.md`
