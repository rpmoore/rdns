...
Generate content for section `section-08-security-review` (filename: `section-08-security-review.md`).
...
for `section-08-security-review` to understand what this section should contain.
...
`/home/rpmoore/code/rdns/docs/plans/edns_cookie_cache/sections/section-08-security-review.md`
