...
Generate content for section `section-02-edns-cookie-module` (filename: `section-02-edns-cookie-module.md`).
...
for `section-02-edns-cookie-module` to understand what this section should contain.
...
`/home/rpmoore/code/rdns/docs/plans/edns_cookie_cache/sections/section-02-edns-cookie-module.md`
